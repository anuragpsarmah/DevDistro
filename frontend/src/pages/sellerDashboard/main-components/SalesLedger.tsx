      ...
      {hasMore && (
        <div className="flex justify-center pt-2">
          <button
            ...
            className="inline-flex items-center gap-3 px-6 py-3 border-2 border-black dark:border-white bg-white dark:bg-[#050505] text-black dark:text-white font-space font-bold uppercase tracking-widest text-xs disabled:opacity-50 disabled:cursor-not-allowed hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors"
          >
