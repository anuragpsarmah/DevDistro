            ...
            <div className="flex flex-col justify-between gap-6 p-6 border-2 border-red-500 bg-red-500/5 mt-auto flex-1">
              <div>
                ...
                <p className="font-space text-sm lg:text-[15px] font-medium leading-relaxed text-gray-700 dark:text-gray-300">
                  Proceeding will permanently delete your DevExchange account, wipe all personal profile data, and unlist any active repositories from the marketplace. <strong className="text-red-500 dark:text-red-400">This action is irreversible.</strong>
                </p>
              </div>
