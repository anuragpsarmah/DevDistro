        ...
        <div className="space-y-4 w-full">
          ...
          {hasStoredButNotConnected ? (
            <p className="text-red-500/80 font-space text-sm leading-relaxed">
              ...
              connected. Disconnect and reconnect to ensure you are synced to
              the correct wallet.
            </p>
          ) : (
            <p className="text-red-500/80 font-space text-sm leading-relaxed">
              The connected wallet address differs from your stored address.
              Disconnect and reconnect to ensure you are synced to the correct
              wallet.
            </p>
          )}
          <div className="flex flex-col space-y-2 pt-2">
            {walletAddress && (
              <div className="flex items-center justify-between text-xs bg-red-500/5 p-3 rounded-none border-2 border-red-500/20">
                <span className="text-red-500 font-space font-bold uppercase tracking-[0.2em]">
                  Stored
                </span>
                <span className="text-red-500 font-mono tracking-wider">
