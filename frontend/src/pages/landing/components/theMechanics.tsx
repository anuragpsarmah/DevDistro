...
export default function TheMechanics() {
  return (
    <section className="py-32 px-6 md:px-12 bg-gray-50 dark:bg-[#0a0a0a] text-black dark:text-white transition-colors duration-300" id="the-mechanics">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-t-2 border-l-2 border-black/20 dark:border-white/20 transition-colors">
          ...
          >
            ...
            <p className="font-space text-sm leading-relaxed text-gray-600 dark:text-gray-400 group-hover:text-black dark:group-hover:text-gray-300 transition-colors">
              Begin with standard GitHub OAuth, followed by our native GitHub App Integration. This grants DevExchange the specific scoped access needed to securely fetch your repository code for packaging.
            </p>
          </motion.div>
          ...
          >
            <div className="font-space text-4xl font-bold mb-8 text-black dark:text-white group-hover:text-red-500 dark:group-hover:text-red-500 transition-colors">02.</div>
            <h3 className="font-syne text-2xl font-bold uppercase mb-4">Set Valuation</h3>
            <p className="font-space text-sm leading-relaxed text-gray-600 dark:text-gray-400 group-hover:text-black dark:group-hover:text-gray-300 transition-colors">
              List your repository metadata on the global marketplace. Set the purchase price in standard USD fiat for total clarity and stability.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="border-b-2 border-r-2 border-black/20 dark:border-white/20 p-10 hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-300 group"
          >
            <div className="font-space text-4xl font-bold mb-8 text-black dark:text-white group-hover:text-red-500 dark:group-hover:text-red-500 transition-colors">03.</div>
            <h3 className="font-syne text-2xl font-bold uppercase mb-4">Solana Settlement</h3>
            <p className="font-space text-sm leading-relaxed text-gray-600 dark:text-gray-400 group-hover:text-black dark:group-hover:text-gray-300 transition-colors">
              A buyer connects their Phantom or Solflare wallet. They execute the purchase paying native SOL equivalent to your USD price. Block confirmation occurs in sub-seconds.
            </p>
          </motion.div>
          ...
          >
            <div className="max-w-3xl">
              ...
              <p className="font-space text-lg leading-relaxed text-gray-600 dark:text-gray-400 group-hover:text-white dark:group-hover:text-black transition-colors">
                The instant the Solana transaction is validated on-chain, DevExchange orchestrates the secure downloading and compiling of your repository into a downloadable ZIP file, immediately served to the buyer. No manual labor required.
              </p>
            </div>
          </motion.div>
