  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col h-full z-10 relative">
        ...
        <h2 className="text-3xl md:text-5xl font-syne font-black uppercase tracking-widest text-black dark:text-white mb-6">
          {title}
        </h2>
        ...
        <ul className="flex flex-col gap-4 mb-12">
          {features.map((feature, index) => (
            <li key={index} className="flex gap-4 items-start">
              <span className="text-red-500 font-bold opacity-50 font-space uppercase text-xs tracking-widest leading-relaxed">/</span>
